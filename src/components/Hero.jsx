...
import heroVideo from '../assets/hero video/lokeshwaran-hero.mp4';
    ...
    <section className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          >
            {heroContent.greeting}, <br /> <span className="text-transparent [-webkit-text-stroke:2.5px_black]">{heroContent.titleHighlight}</span>
          </h1>
...
{/* Resume Download Button */}
  ...
  download
  className="px-4 py-2 md:px-6 md:py-2 text-xs md:text-base rounded-full bg-white/10 border border-blue-400/70 text-black font-semibold hover:bg-blue-500/20 hover:border-blue-400 transition-all duration-300 backdrop-blur-md shadow-[0_0_15px_rgba(37,99,235,0.2)] flex items-center gap-2"
>
  <svg 
    className="w-4 h-4" 
    fill="none" 
  ...
  >
    <path 
      ...
      strokeWidth="2" 
      d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2h-3.586"
    />
  </svg>
  ...
  <a 
    ...
    className="px-4 py-2 md:px-6 md:py-2 text-xs md:text-base rounded-full bg-black/40 border border-white/70 text-white font-semibold hover:bg-black/60 transition-all duration-300 backdrop-blur-md"
  >
